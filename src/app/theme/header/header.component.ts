...
export class HeaderComponent implements OnInit {
	...
	ngOnInit(): void {
		...
		this.router.events.pipe(filter((e): e is NavigationEnd => e instanceof NavigationEnd)).subscribe((e: any) => {
	...
	userSelected(userId: any) {
		this.authService.impersonate(userId).subscribe(
			(res: any) => {
				if (res.data.impersonate.status === 'this is the latest and greatest token') {
